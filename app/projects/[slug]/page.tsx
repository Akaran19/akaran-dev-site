...
const projectDetails: Record<string, {
  ...
  'world-cup-sentiment': {
    ...
    papers: [
      { title: "World Cup Twitter Sentiment Analysis Study", url: "/papers/world-cup-sentiment.pdf" }
    ]
  },
  'pacman-eye-tracking': {
    ...
    papers: [
      { title: "Investigating Cognitive Load in Pac-Man Gameplay through Eye Tracking", url: "/papers/pacman-eye-track.pdf" }
    ]
  },
  'topic-modelling-syllabus': {
    ...
    papers: [
      { title: "Topic Modelling of Cognitive Science Syllabi", url: "/papers/CogSci-topic-modelling.pdf" }
    ]
  },
  'peerly-platform': {
    ...
    <Section>
      <div className="max-w-4xl mx-auto">
        ...
        {project.papers && project.papers.length > 0 && (
          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4 text-white">Related Publications</h2>
